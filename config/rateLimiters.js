...
export const api_user_limiter = rateLimit({
  windowMs: userWindow,
  max: userMax,
  message: `<div><h1>⚠Too many login/signup requests. Please try in ${formatTime(userWindow)}.</h1><a href='/blogs'>Leave this page</a></div>`,
...
export const api_blogs_limiter = rateLimit({
    windowMs: blogWindow,
    max: blogMax,
    message:`<div><h1>⚠Too many blog requests. Please try in ${formatTime(blogWindow)}.</h1><h2><a href='/about'>Leave this page</a></h2></div>`,
    standardHeaders: true,
    legacyHeaders: false,
  });
